...
echo ""
echo "Optional — add Spine (commit-driven feature docs in the same vault):"
echo "  ./scripts/spine-setup.sh && ./scripts/integrate-spine-obsidian.sh"
echo "Optional — teach obsidian-second-brain Obsidian format skills:"
echo "  ./scripts/obsidian-skills-setup.sh && ./scripts/integrate-obsidian-skills.sh"
echo "  Or run everything: ./scripts/knowledge-stack-setup.sh"
