...
| **[deepstock](https://github.com/afidurko/deepstock)** | Legacy TF1 deep-learning stock experiments (news Text CNN, price ConvNet). Archival reference for `aoa_financial` sentiment/forecast lineage. |
