...
| ATTL mesh (`aoa attl` / `attl` log rows) | 4 | 200k | 2 (maker + verifier when coding) |
| Integrity Ten (`aoa integrity`) | 8 | 100k | 0 (deterministic checks; Reed handoff only after approve) |
